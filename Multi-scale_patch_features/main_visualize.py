...
def main():
    ...
    detection_auroc = results['det_sum']
    segmetation_auroc = results['seg_sum']
    detection_aupr= results['aupr_det_sum']
    segmetation_aupr = results['aupr_seg_sum']


    #print(img_score)

    print('Detection auroc :',detection_auroc)
    print("-----------------------------------------")
    print('Segmetation_auroc :',segmetation_auroc)
    print("-----------------------------------------")
    print('Detection_aupr :',detection_aupr)
    print("-----------------------------------------")
    print('Segmetation_aupr :',segmetation_aupr)
    print("-----------------------------------------")

    print(maps.shape)
    np.save('/home/mayooran/mugunthan/patchcore-inspection-main/PATCH_CORE/Ensemble_model/multiscale_segmentation_grid.npy',maps)
